      ...
      >
        <div className="flex flex-col lg:flex-row gap-12 items-stretch">
          ...
          <div className="lg:w-1/2 flex flex-col">
            ...
            <div className="grid gap-4 flex-grow">
              {t.items.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center justify-between p-5 bg-gray-50 rounded-2xl border border-gray-100 hover:border-[#D4AF37] transition-all group"
                >
          ...
          <div className="lg:w-1/2 w-full">
            <div className="bg-[#1f7a5a] p-8 rounded-[3rem] text-white h-full shadow-2xl relative overflow-hidden flex flex-col justify-center">
              {/* لمسة جمالية خلفية */}
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-7xl font-black mb-12 flex items-baseline gap-2">
                  ...
                  <span className="text-2xl text-[#D4AF37]">{t.currency}</span>
                </h3>
